...
class ObatController extends Controller
{
    public function obat(){
        ...
        $obat = obat::all();
        return view('userPetugas.DataObat.obat', compact('obat'));
    }

    public function formObat(){

        $obat = Obat::all();
        return view('userPetugas.DataObat.createObat', compact('obat'));
    }
    ...
    public function createObat(Request $request){
        ...
        return redirect()->route('petugas.index.obat');
    }

    public function showObat(Obat $obat)
    {
        $obat = Obat::findOrFail($obat->id);
        return view('userPetugas.obatUKS.showObat', compact('obat'));
    } 
