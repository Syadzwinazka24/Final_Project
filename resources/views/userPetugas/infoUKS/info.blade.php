...
<div class="rounded h-100 p-4">
    ...
    <button href="" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modal-default">Add Info</button>
    @include('userPetugas.infoUKS.create')

    <!-- Search start -->
    <div class="card-tools">
        <div class="input-group input-group-sm" style="width: 200px; margin-left: 48rem;">
            <form action="{{ route('petugas.Info.search') }}" method="get">
