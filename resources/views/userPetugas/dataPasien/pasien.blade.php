...
<div class="rounded h-100 p-4">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            @include('userPetugas.dataPasien.showPasien')
            @include('userPetugas.dataPasien.updatePasien')
            @include('userPetugas.dataPasien.deletePasien')
            @endforeach
        </tbody>
    </table>
</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('petugas.tambah.pasien') }}" method="post">
                    @csrf
                    <div class="mb-2">
